...
public sealed class BackupEmailService : DynuEmailServiceBase
{
    [JsonPropertyName("type")]
    public override EmailType Type => EmailType.EmailBackup;
    ...
    {
        if (!base.Equals(obj) || obj is not BackupEmailService other)
            return false;
