...
public sealed class FullEmailService : DynuEmailServiceBase
{
    [JsonPropertyName("type")]
    public override EmailType Type => EmailType.FullServiceEmail;
    ...
    {
        if (!base.Equals(obj) || obj is not FullEmailService other)
            return false;
